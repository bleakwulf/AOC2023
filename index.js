...
try {
  // rawInputData = fs.readFileSync(`${__dirname}/D10/input.txt`, "utf8");
  // rawInputData = fs.readFileSync(`${__dirname}/D10/demo1.txt`, "utf8");
  // rawInputData = fs.readFileSync(`${__dirname}/D10/demo2.txt`, "utf8");
  rawInputData = fs.readFileSync(`${__dirname}/D10/demo3.txt`, "utf8");
} catch (e) {
  console.log(`Error!`);
  console.error(e);
}
